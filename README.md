...
자녀 세대에는 투자 기회를, 부모 세대에는 투자 인식을 개선하여 더 많은 세대가 주식 투자에 관심을 가지도록 하는 신한 투자 증권 서비시의 신기능 제안.
...
## 📈 분석 배경 EDA
분석 내용을 간단하게 요약하자면, 2030 자녀 세대는 적은 자산 투자의 한계점으로 인해 높은 이탈율, 5060 부모 세대는 안전 자산을 선호하고 소극적인 주식 투자 성향으로 인해 무거래 비율이 높은 것으로 나타났다. 특히 연령대별 투자 성향 설문조사 결과 데이터에서 실제 자산 포트폴리오 현황과 정반대의 결과(부모 세대는 공격형, 자녀 세대는 안정형)를 보였다.
...
| 효과 | 내용 |
|------|------|
| **👨‍👩‍👧‍👦 세대 간 투자 참여 확대** | 부모 세대는 자녀와의 투자를 통해 주식 투자에 대한 두려움 감소 및 관심 향상, 자녀 세대는 더 큰 규모의 투자 경험을 제공합니다. |
| **🎯 공동 목표를 통한 투자 동기 부여** | 가족이 함께 공통 목표를 설정하고 달성해나가는 과정에서 투자에 대한 관심도 자연스럽게 증진합니다. |
| **💬 가족 신뢰 강화** | 실시간 투자 현황 대시보드와 포트폴리오 변화 알림을 통해 투명한 투자 내역 확인 및 가족과의 소통 증대합니다. |
